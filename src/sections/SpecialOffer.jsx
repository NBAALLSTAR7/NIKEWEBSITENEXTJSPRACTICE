...
const SpecialOffer = () => {
  return (
   ...
   <div className="flex-1">
    <img src={offer} alt="demo" width={773} height={687} className='object-contain
    w-full
    ' />
   </div>
   <div className='flex flex-1 flex-col'>
    ...
    we offer unparelleled value that sets us apart.


    </p>
    <p className='mt-6 lg:max-w-lg info-text'>
    Navigate a realm of possibilities designed to fullfill your unique desires
