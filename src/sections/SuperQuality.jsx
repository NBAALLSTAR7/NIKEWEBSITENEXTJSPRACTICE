...
const SuperQuality = () => {
  return (
   ...
   <div className='flex flex-1 flex-col'>
    ...
    Ensuring premium comfort and style,out meticulously crafted footwear is designed to 
   ...
   <img src={shoe8} alt="shoe8" width={570} height={522} className='object-contian' />
